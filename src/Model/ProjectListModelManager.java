...
//    edit(project, data);
  ...
  @Override public void addProject(ArrayList<Object> data){
    Project project;
    if (data.size() == 11){
       project = new ResidentialProject((String)data.get(0), (String)data.get(1), (Integer) data.get(2),(Integer) data.get(3),Long.parseLong(data.get(4).toString()),(MyDate) data.get(5),(Integer) data.get(6), (Integer) data.get(7), (Integer) data.get(8), (Integer) data.get(9) ,(Boolean) data.get(10));
    }
    else if (data.size() == 9)
    {
       project = new CommercialProject((String)data.get(0), (String)data.get(1), (Integer) data.get(2),(Integer) data.get(3),Long.parseLong(data.get(4).toString()),(MyDate) data.get(5),(Integer) data.get(6), (Integer) data.get(7), (String) data.get(8));
    }
    else if (data.size() == 8)
    {
       project = new IndustrialProject((String)data.get(0), (String)data.get(1), (Integer) data.get(2),(Integer) data.get(3),Long.parseLong(data.get(4).toString()),(MyDate) data.get(5),(String) data.get(6), (Integer) data.get(7));
    }
    else {
       project = new RoadProject((String)data.get(0), (String)data.get(1), (Integer) data.get(2),(Integer) data.get(3),Long.parseLong(data.get(4).toString()),(MyDate) data.get(5),(Integer) data.get(6), (Integer) data.get(7),(Integer) data.get(8),(ArrayList<String>) data.get(9));
    }
